...
#
# ⚠️  DEPRECATED: This file generates a NEW suffix every time it's sourced.
# ⚠️  Use .env file instead (auto-generated by .devcontainer/generate-env.sh)
# ⚠️  The .env file maintains a consistent suffix for the entire container lifecycle.
#
# To regenerate .env with new suffix:
#   rm .env && bash .devcontainer/generate-env.sh && source .env
